...
describe('XhrPlugin tests', () => {
    ...
    test('when XHR is called and w3c trace format disabled then the plugin records a trace', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
    ...
    test('when XHR is called and w3c trace format enabled then the plugin records a trace', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
            logicalServiceName: 'sample.rum.aws.amazon.com',
            urlsToInclude: [/response\.json/]
    ...
    test('when XHR returns an error code with w3c format disabled then the plugin adds the error to the trace', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
            ...DEFAULT_CONFIG,
            ...{
    ...
    test('when XHR returns an error code with w3c format enabled then the plugin adds the error to the trace', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
            ...DEFAULT_CONFIG,
            ...{
    ...
    test('when url matches some regex in addXrayTraceIdHeader with w3c format disabled then X-Amzn-Trace-Id header is added to the HTTP request', async () => {
        // Init
        let header: string | null;
        const config: Partial<HttpPluginConfig> = {
    ...
    test('when url matches some regex in addXrayTraceIdHeader with w3c format enabled then traceparent header is added to the HTTP request', async () => {
        // Init
        let header: string | null;
        const config: Partial<HttpPluginConfig> = {
            addXRayTraceIdHeader: [/noMatch/, /.*response.json$/]
    ...
    test('when url matches no regex in addXrayTraceIdHeader then X-Amzn-Trace-Id header is not added to the HTTP request', async () => {
        // Init
        let header: string | null;
        const config: Partial<HttpPluginConfig> = {
    ...
    test('when the plugin records a trace with w3c format disabled then the trace id is added to the http event in xray format', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
            logicalServiceName: 'sample.rum.aws.amazon.com',
            urlsToInclude: [/response\.json/],
    ...
    test('when the plugin records a trace with w3c format enabled then the trace id is added to the http event in w3c format', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
            logicalServiceName: 'sample.rum.aws.amazon.com',
            urlsToInclude: [/response\.json/],
    ...
    test('when XHR aborts with tracing with w3c format disabled then the trace id is added to the http event in xray format', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
            logicalServiceName: 'sample.rum.aws.amazon.com',
            urlsToInclude: [/response\.json/]
    ...
    test('when XHR aborts with tracing with w3c format enabled then the trace id is added to the http event in w3c format', async () => {
        // Init
        const config: Partial<HttpPluginConfig> = {
            logicalServiceName: 'sample.rum.aws.amazon.com',
            urlsToInclude: [/response\.json/]
